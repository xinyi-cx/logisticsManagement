...
INSERT INTO address_sender (id, address, city, company, country_code, email, fid, name, phone, postal_code, create_user, update_user, created_time, updated_time, is_delete) VALUES (1, 'admin', '北京', '公司', 'PL', 'ry@163.com', 1495, '管理员', '15888888888', '02274', '1', '1', '2022-01-24 17:43:27', '2022-01-24 17:43:33', 0);
...
(
    ...
    `order_no`      varchar(500) DEFAULT NULL comment '订单号',
    ...
    `content`        varchar(500) DEFAULT NULL comment '备注',
    `reference`      varchar(500) DEFAULT NULL comment '内部引用号',
    `package_reference`      varchar(500) DEFAULT NULL comment 'package内部引用号',
    `depot`      varchar(500) DEFAULT NULL comment 'depot',
    `pack_id`        bigint(20)   DEFAULT NULL comment 'pack_id',
