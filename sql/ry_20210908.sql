...
insert into sys_menu values('11', '面单管理', '0', '2', 'tool',             null, '', 1, 0, 'M', '0', '0', '', 'tool',     'admin', sysdate(), '', null, '面单管理目录');
insert into sys_menu values('12', '跟踪管理', '0', '3', 'tool',             null, '', 1, 0, 'M', '0', '0', '', 'tool',     'admin', sysdate(), '', null, '跟踪管理目录');
-- 二级菜单
