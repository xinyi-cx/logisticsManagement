...
public class MultpartFileToByte {

//    public void getFile() throws IOException {
//        MultipartFile multipartFile = getMultipartFile();
//        MultipartFile multipartFile2 = getMultipartFile(multipartFile.getBytes());
//    }
    ...
    //MultipartFile转换为二进制
    public static byte[] getByte(MultipartFile multipartFile) throws IOException {
