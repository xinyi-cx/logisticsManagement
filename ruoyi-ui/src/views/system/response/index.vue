<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="${comment}" prop="sessionId">
        <el-input
      ...
      <el-form-item label="${comment}" prop="packageId">
        <el-input
      ...
      <el-form-item label="${comment}" prop="packId">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:response:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:response:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:response:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="responseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="sessionId" />
      <el-table-column label="${comment}" align="center" prop="packageId" />
      <el-table-column label="${comment}" align="center" prop="status" />
      <el-table-column label="${comment}" align="center" prop="pkgReference" />
      <el-table-column label="${comment}" align="center" prop="pkgStatus" />
      <el-table-column label="${comment}" align="center" prop="packId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="${comment}" prop="sessionId">
          <el-input v-model="form.sessionId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="packageId">
          <el-input v-model="form.packageId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="pkgReference">
          <el-input v-model="form.pkgReference" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="${comment}" prop="packId">
          <el-input v-model="form.packId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="createUser">
...
<script>
import { listResponse, getResponse, delResponse, addResponse, updateResponse } from "@/api/system/response";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除面单返回值编号为"' + ids + '"的数据项？').then(function() {
