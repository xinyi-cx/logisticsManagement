<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="返回值" prop="msgCode">
        <el-input
    ...
    <el-table v-loading="loading" :data="msgList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="返回值" align="center" prop="msgCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="返回值" prop="msgCode">
          <el-input v-model="form.msgCode" placeholder="请输入返回值" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除马帮信息编号为"' + codes + '"的数据项？').then(function() {
        return delMsg(codes);
      }).then(() => {
        this.getList();
