    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:authorization:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:authorization:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:authorization:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:authorization:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listAuthorization, getAuthorization, delAuthorization, addAuthorization, updateAuthorization } from "@/api/system/authorization";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getAuthorization(userId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户授权信息编号为"' + userIds + '"的数据项？').then(function() {
        return delAuthorization(userIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/authorization/export', {
        ...this.queryParams
