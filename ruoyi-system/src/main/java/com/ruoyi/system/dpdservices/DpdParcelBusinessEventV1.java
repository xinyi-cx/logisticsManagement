...
/**
 * <p>Java class for dpdParcelBusinessEventV1 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="dpdParcelBusinessEventV1"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="countryCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="eventCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="eventDataList" type="{http://dpdservices.dpd.com.pl/}dpdParcelBusinessEventDataV1" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "dpdParcelBusinessEventV1", propOrder = {
    "countryCode",
    "eventCode",
    "eventDataList",
    "eventTime",
...
public class DpdParcelBusinessEventV1 {

    protected String countryCode;
    protected String eventCode;
    @XmlElement(nillable = true)
    protected List<DpdParcelBusinessEventDataV1> eventDataList;
     ...
     * {@link DpdParcelBusinessEventDataV1 }
     * 
     * 
     */
    public List<DpdParcelBusinessEventDataV1> getEventDataList() {
        if (eventDataList == null) {
            eventDataList = new ArrayList<DpdParcelBusinessEventDataV1>();
        }
