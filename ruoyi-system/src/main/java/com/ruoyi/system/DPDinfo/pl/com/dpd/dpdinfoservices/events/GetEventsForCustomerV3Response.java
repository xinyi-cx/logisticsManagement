...
/**
 * <p>getEventsForCustomerV3Response complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getEventsForCustomerV3Response">
 *   &lt;complexContent>
...
@XmlType(name = "getEventsForCustomerV3Response", propOrder = {
    "_return"
})
public class GetEventsForCustomerV3Response {
